...
- Der experimentelle editierbare PPTX-Export (siehe Eintrag weiter unten) verwendet für echte `<img>`-Bildverweise jetzt die Original-Bilddatei statt eines Browser-Screenshots -- bessere Bildqualität, kleinere Dateigröße. Formeln/Diagramme/Chrome/Tabellen bleiben unverändert Screenshots.
