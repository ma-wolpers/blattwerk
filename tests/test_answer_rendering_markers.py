...
def test_geometry_yaml_uses_marker_visibility_symbols():
    options = {"type": "geometry", "rows": "6", "cols": "6"}
    content = (
        "points:\n"
...
def test_geometry_yaml_legacy_word_show_values_are_not_rendered():
    options = {"type": "geometry", "rows": "4", "cols": "4"}
...
def test_geometry_fallback_solution_text_is_only_rendered_in_solution_mode():
    options = {"type": "geometry", "rows": "4", "cols": "4"}
