...
function shouldValidateDocument(document: vscode.TextDocument): boolean {
  ...
  const hasDirective = /(^|\n)\s*:::(material|info|task|subtask|lines|grid_field|grid_system|dots|space|table|numberline|mc|cloze|matching|wordsearch|solution|columns|nextcol|endcolumns|help|hilfe)\b/m.test(text);
