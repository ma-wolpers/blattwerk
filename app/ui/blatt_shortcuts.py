...
def build_preview_keybinding_registry(app) -> KeybindingRegistry:
    ...
    registry.register_many(
        [
            ...
            KeyBindingDefinition("preview.refresh", "<space>", UiIntent.PREVIEW_REFRESH, (UI_MODE_PREVIEW,), "Leertaste   Vorschau aktualisieren", handler=app._compile_now),
            ...
            KeyBindingDefinition("global.help_preview", "<Control-Shift-h>", UiIntent.GLOBAL_HELP_PREVIEW, (UI_MODE_GLOBAL, UI_MODE_DIALOG), "Strg+Shift+H   Lernhilfenansicht", allow_modifiers=True, allow_when_text_input=True, handler=app.open_help_preview_window),
            ...
            KeyBindingDefinition("global.new_file", "<Control-n>", UiIntent.GLOBAL_NEW_FILE, (UI_MODE_GLOBAL, UI_MODE_DIALOG), "Strg+N   neues Dokument", allow_modifiers=True, allow_when_text_input=True, handler=app.create_new_markdown_file),
            ...
            KeyBindingDefinition("global.cycle_font", "<Control-Shift-f>", UiIntent.GLOBAL_CYCLE_FONT, (UI_MODE_GLOBAL, UI_MODE_DIALOG), "Strg+Shift+F   Schriftprofil wechseln", allow_modifiers=True, allow_when_text_input=True, handler=app._cycle_font_profile),
