...
def inspect_document_text(markdown_text: str, *, detection_mode: str = "yaml_keys") -> DocumentDiagnosticsResult:
    ...
    document_type = detect_document_type_from_meta(meta or {}, detection_mode=normalized_detection_mode)
...
def inspect_document_path(input_path: str | Path, *, detection_mode: str = "yaml_keys") -> DocumentDiagnosticsResult:
    ...
    return inspect_document_text(text, detection_mode=detection_mode)
